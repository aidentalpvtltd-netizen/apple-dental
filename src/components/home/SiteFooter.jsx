...
import { BackToTopLink } from '../BackToTopLink.jsx'
import { ComingSoonPopup } from '../ComingSoonPopup.jsx'

export function SiteFooter() {
  const [comingSoonChannel, setComingSoonChannel] = useState('')
  const comingSoonLabel = comingSoonChannel === 'x' ? 'X' : 'LinkedIn'
    ...
    <footer className="site-footer">
      <div className="site-footer-inner">
        ...
        <div className="footer-social-links" aria-label="Social media links">
          ...
          <a href="https://www.facebook.com/apple.fbid/" target="_blank" rel="noreferrer" aria-label="Facebook">
            <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          ...
          <button type="button" aria-label="X" onClick={() => setComingSoonChannel('x')}>
            <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          ...
          <button type="button" aria-label="LinkedIn" onClick={() => setComingSoonChannel('linkedin')}>
            <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      ...
      <BackToTopLink />
      <ComingSoonPopup
        eyebrow={comingSoonLabel}
        isOpen={Boolean(comingSoonChannel)}
        message={`${comingSoonLabel} updates for Apple International Dental are coming soon. Please follow us on Instagram or Facebook for now.`}
        onClose={() => setComingSoonChannel('')}
      />
    </footer>
  )
}
